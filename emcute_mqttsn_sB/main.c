...
void get_temp(char* temp){
    sprintf(temp, "%d", get_rnd(-50,50));
}

void get_hum(char* hum){
    sprintf(hum, "%d", get_rnd(0,100));
}

void get_windir(char* windir){
    sprintf(windir, "%d", get_rnd(0,360));
}

void get_winint(char* winint){
    sprintf(winint, "%d", get_rnd(0,100));
}

void get_rain(char* rain){
    sprintf(rain, "%d", get_rnd(0,50));
}
...
static int cmd_station(int argc, char **argv)
{
    ...
    while(1){
        ...
        char arg3[4];
        get_temp(arg3);
        char *args[3] = {"pub", "/sensor/stationB/data/temp", arg3};
        cmd_pub(3,args);
        sleep(5);

        char arg4[4];
        get_hum(arg4);
        char *args1[3] = {"pub", "/sensor/stationB/data/hum", arg4};
        cmd_pub(3,args1);
        sleep(5);

        char arg5[4];
        get_windir(arg5);
        char *args2[3] = {"pub", "/sensor/stationB/data/windir", arg5};
        cmd_pub(3,args2);
        sleep(5);

        char arg6[4];
        get_windir(arg6);
        char *args3[3] = {"pub", "/sensor/stationB/data/winint", arg6};
        cmd_pub(3,args3);
        sleep(5);

        char arg7[4];
        get_windir(arg7);
        char *args4[3] = {"pub", "/sensor/stationB/data/rain", arg7};
        cmd_pub(3,args4);
        sleep(5);
...
static const shell_command_t shell_commands[] = {
    ...
    { "station", "start virtual station", cmd_station},
    { NULL, NULL, NULL }
};
